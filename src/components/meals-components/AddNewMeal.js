...
const AddNewMeal = ({ history, location }) => {
  ...
  const form = (
    <Form onSubmit={handleSubmit}>
      ...
      <Form.Group>
        ...
        <DatePicker
          ...
          onChange={(selecteDate) =>
            handleChange({ target: { name: "deliversOn", value: selecteDate } })
          }
      ...
      <Form.Group>
        <Form.Label htmlFor="orderStarts">
          {" "}
          Accepting order from (date and time):
        </Form.Label>
        <br />
        <DatePicker
          name="orderStarts"
          ...
          onChange={(selecteDate) =>
            handleChange({
              target: { name: "orderStarts", value: selecteDate },
            })
          }
      ...
      <Form.Group>
        <Form.Label htmlFor="orderEnds">
          {" "}
          Order ends from (date and time):
        </Form.Label>
        <br />
        <DatePicker
          name="orderEnds"
          ...
          onChange={(selecteDate) =>
            handleChange({ target: { name: "orderEnds", value: selecteDate } })
          }
  ...
  const unauthorized = (
    <p className="text-danger">
      Oops! It appears you are not an authorised seller with us. Make sure you
      have registered as a seller with us.
    </p>
  );
